...
For **three runnable starter files** in the repo (`examples/approval_flow.tq`, `examples/ai_generated.json`, CI notes in `examples/ci_check.md`), see **[Starter use cases](use-cases.md)**.

...
You already ran [QUICKSTART.md](QUICKSTART.md). This page is the **next** small loop: own a file, rebuild, optionally use a package.

## 1. Own a `.tq` file

1. Copy [`examples/torqa/templates/minimal.tq`](../examples/torqa/templates/minimal.tq) (or [`examples/workspace_minimal/app.tq`](../examples/workspace_minimal/app.tq)) into a folder you control.

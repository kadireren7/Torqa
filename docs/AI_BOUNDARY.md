...
- Authoring contract (system prompt + reference payload): `src/language/authoring_prompt.py` — stays aligned with `default_ir_function_registry` and handoff rules. CLI: `project-x language`.

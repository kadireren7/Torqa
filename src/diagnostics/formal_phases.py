...
_WELLFORMED = frozenset(
    {
        ...
        c.PX_SEM_LOGIC_UNREACHABLE,
        c.PX_SEM_LOGIC_NON_TERMINATING,
        c.PX_SEM_LOGIC_EFFECT_ORDER,
        c.PX_SEM_LOGIC_MISSING_EFFECT,
        c.PX_SEM_LOGIC_CONTRADICTORY_PRECONDITION,
        c.PX_SEM_LOGIC_REQUIRED_EFFECT,
        c.PX_SEM_LOGIC_TQ_MODEL_INPUT,
    }
)

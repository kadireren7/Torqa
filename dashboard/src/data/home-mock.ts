...
export const MOCK_HOME_DASHBOARD: HomeDashboardData = {
  ...
  policyFailures30d: 5,
  highRiskScans30d: 9,
  scheduleSuccessRate30d: 91,
  topFindingRules: [
    { ruleId: "v1.http.tls_verification_disabled", count: 6 },
    { ruleId: "v1.webhook.public_no_auth", count: 4 },
    { ruleId: "v1.http.missing_error_handling", count: 3 },
  ],
